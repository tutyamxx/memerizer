...
describe('🎯 Testing (Bye Mom) API endpoint', () => {
    ...
    it('POST - Should return a message and a status code of (400) if the `searchquery` is empty but a valid image URL is attached', (done) => {
    ...
    it('POST - Should return a message and a status code of (400) if the `searchquery` query length is higher than 34 characters but a a valid image URL is attached', (done) => {
